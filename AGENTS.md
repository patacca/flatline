...
- Next: P6 macOS/Windows host-feasibility work; P7 enriched output deferred behind ADR-012.
...
- ADR-008 (Cross-Platform Order): unresolved; tracked in `docs/roadmap.md`.
...
- Docs/notes: `docs/`, `docs/ai/`, `docs/release_notes.md`, `docs/release_review.md`, `docs/release_workflow.md`, `notes/api/decompiler_inventory.md`, `notes/r2ghidra/integration_map.md`.
...
- Specs: `tests/specs/test_catalog.md` (44 definitions, 5 categories, traceability matrix), `tests/specs/fixtures.md` (10 fixtures, oracle strategy, determinism rules).
