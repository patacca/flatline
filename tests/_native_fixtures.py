...
_FIXTURES: dict[str, NativeFixture] = {
    ...
    "fx_external_call_arm64": NativeFixture(
        fixture_id="fx_external_call_arm64",
        language_id="AARCH64:LE:64:v8A",
        compiler_spec="default",
        hex_filename="fx_external_call_arm64.hex",
        sha256="fd6522d4ba36819a47a682f76e40cf6d19c7894de453e40d7f1185f22cc0eff1",
        normalized_c="xunknown8 func_1000 ( void ) { func_0x00001018 ( ) ; return 0 ; }",
