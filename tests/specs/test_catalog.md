...
| U-021 | Validate release readiness audit happy path | Synthetic repo with version files and release docs | Audit the release-readiness helper against a compliant synthetic repo | The initial public release stays classified as `0.1.0` from `0.1.0.dev0` with all required artifacts present | Release-readiness audit oracle | The first public tag recommendation and required artifact enumeration remain explicit |
