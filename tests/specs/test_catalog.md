...
| §7 Release automation | GitHub Actions release automation builds and audits distributions, publishes GitHub releases to PyPI, routes manual dispatches to TestPyPI, keeps the locked wheel matrix explicit, and smoke-tests the published index artifacts on the Tier-1 matrix | U-025 |
