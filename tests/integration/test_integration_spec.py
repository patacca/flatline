...
real Ghidra runtime data. Auto-skipped when the native bridge is unavailable.
"""
...
def test_i007_warning_only_success_with_warning_structure():
    ...
    (str), phase (str from {init, analyze, emit}). Covers specs.md section 3.4 warning-only
    success invariant and section 3.3 WarningItem structure."""
    _skip_spec_only()
