                ...
                "pcode": {
                    "pcode_ops": [
                        ...
                        },
                        {
                            "id": 2,
                            "opcode": "CBRANCH",
                            "instruction_address": request_payload["function_address"] + 6,
                            "sequence_time": 3,
                            "sequence_order": 2,
                            "input_varnode_ids": [4],
                            "output_varnode_id": None,
                            "true_target_address": request_payload["function_address"] + 0x10,
                            "false_target_address": request_payload["function_address"] + 0x20,
                        },
                        {
                            "id": 3,
                            "opcode": "RETURN",
                            "instruction_address": request_payload["function_address"] + 9,
                            "sequence_time": 4,
                            "sequence_order": 3,
                            "input_varnode_ids": [2],
                            "output_varnode_id": None,
        ...
        return {
            ...
            "function_info": {
                ...
                "call_sites": [
                    {
                        "instruction_address": request_payload["function_address"] + 3,
                        "target_address": request_payload["function_address"] + 0x20,
                    }
                ],
                "jump_tables": [],
                "diagnostics": {
